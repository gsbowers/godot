...
while finishing < 1:
    ...
    lm_data_file = (time.strftime("/home/vladimir/github/godot/bpi/listmode/python/single/data/lm4_mod_%y%m%d_%H%M%S.csv"))
    ...
    while (length < filelength and finishing < 1 and filefinishing < 1) :
        ...
        if lm_counts == 0:
            ...
            first2lasttime=[0,0]
            continue
        first2=lm_data[0:2] #Not sure why, but this is needed to give us 1st 2 words
