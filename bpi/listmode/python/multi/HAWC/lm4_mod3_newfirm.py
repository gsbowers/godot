...
def lm4_mod3_newfirm(all_morpho, sn, seconds):
  ...
  t0file = "/home/vladimir/GODOT/t0/%s%s"%(sn,time.strftime("_lm4_mod3_newfirm_t0_%y%m%d_%H%M%S.csv"))
  f=open(t0file,'w')
  ...
  while finishing < 1:
      ...
      lm_data_file = "/home/vladimir/GODOT/data/%s%s.csv"%(sn,time.strftime("_lm4_mod3_newfirm_%y%m%d_%H%M%S"))
