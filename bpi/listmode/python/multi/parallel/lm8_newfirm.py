...
def lm8_newfirm(all_morpho, sn, seconds):
  ...
  while finishing < 1:
      ...
      lm_data_file = "/home/vladimir/github/godot/bpi/listmode/python/multi/parallel/data/%s%s_%2.0f.csv"%(sn,time.strftime("_lm8_newfirm_%y%m%d_%H%M%S"),max_buffer_frac*100)
